...
DNN = neural_network.DeepNeuralNetwork(0.01, number_of_hidden_layers=1, input_size=27,
                                       hidden_layer_size_1=27, output_size=9, initialise=True)
QTable = q_table.QTable(19683, 9, initialize=True, content=0.6)
...
for i in range(10):
    tictactoe.train(DQN_P1_train, DQN_P2_train, episodes=10000)
    tictactoe.play(DQN_P_test, Random_P1, episodes=1000)
    DNN.save_weights()
